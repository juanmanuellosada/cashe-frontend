-- ============================================
-- SCRIPT COMPLETO DE GENERACIÓN DE REGLAS
-- Para user_id: 1a753dba-096e-4453-8ddb-87ace889a1f6
-- ============================================

-- PASO 1: Crear la función generadora (si no existe)
-- ============================================
...
-- ============================================
SELECT * FROM generate_auto_rules_for_user('1a753dba-096e-4453-8ddb-87ace889a1f6');
