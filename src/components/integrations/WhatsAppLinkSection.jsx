    ...
    <div className="space-y-4 mb-4">
      ...
      >
        <div className="flex items-start gap-3">
          ...
          <div>
            <h4 className="font-semibold text-sm mb-1" style={{ color: '#25D366' }}>
      ...
      >
        ...
        <div className="space-y-2 text-sm" style={{ color: 'var(--text-secondary)' }}>
          <div className="flex items-center gap-2 p-2 rounded-lg" style={{ backgroundColor: 'var(--bg-secondary)' }}>
            <span>💬</span>
            <code className="text-xs" style={{ color: '#25D366' }}>"Gasté 500 en comida con galicia"</code>
          </div>
          <div className="flex items-center gap-2 p-2 rounded-lg" style={{ backgroundColor: 'var(--bg-secondary)' }}>
            <span>💬</span>
            <code className="text-xs" style={{ color: '#25D366' }}>"Cobré 50000 de sueldo en santander"</code>
          </div>
          <div className="flex items-center gap-2 p-2 rounded-lg" style={{ backgroundColor: 'var(--bg-secondary)' }}>
            <span>💬</span>
            <code className="text-xs" style={{ color: '#25D366' }}>"Transferí 10k de mp a brubank"</code>
          </div>
          <div className="flex items-center gap-2 p-2 rounded-lg" style={{ backgroundColor: 'var(--bg-secondary)' }}>
            <span>💬</span>
            <code className="text-xs" style={{ color: '#25D366' }}>"Cuánto gasté en comida este mes?"</code>
          </div>
          <div className="flex items-center gap-2 p-2 rounded-lg" style={{ backgroundColor: 'var(--bg-secondary)' }}>
            <span>💬</span>
            <code className="text-xs" style={{ color: '#25D366' }}>"Saldo mercadopago"</code>
          </div>
        </div>
      </div>
